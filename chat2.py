...
noun = openai.Completion.create(model="text-davinci-003", prompt="Generate a noun of a living thing that needs an excuse, including the reason it needs one:", temperature=0.8, max_tokens=10)
noun2 = noun["choices"]
nounreal=noun2[0]
...
ttk.Label(text="Who are you? What did you do? Enter below.").place(anchor="center",relx=0.5,rely=0.65)
